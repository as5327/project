...
<body id="page-top">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a
							href="${pageContext.request.contextPath}/admin/basicInfo_management/courseManagement.do">기초
							정보 관리 > 과정 관리</a>
					</div>
					<div class="card-body">
										...
										<tr>
											...
											<td>
												...
												<button type="button"
													...
													${c.courseDel == 0 ? "":"disabled='disabled'"}>삭제</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
	...
	<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">과정 삭제</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
						...
						<form>
							<div class="form-group">
								<div class="form-label-group">
									<p>CO001 / 웹 기반 빅데이터 분석 응용 SW 개발자</p>
								</div>
								<div class="form-label-group">
									<p>삭제하시겠습니까?</p>
								</div>
	...
	<div class="modal fade" id="inputModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">과정 등록</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
				...
				<div class="modal-body">
					<div class="card-body">
						<div class="form-group">
							<form action="${pageContext.request.contextPath}/admin/basicInfo_management/course/insert.do" method="POST" enctype="multipart/form-data">
								<div class="form-group">
	...
	<div class="modal fade" id="updateModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">과정 수정</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
				...
				<div class="modal-body">
					<div class="card-body">
						<div class="form-group">
							<form>
								<div class="form-group">
									<label for="subjectId">과정번호</label> <input type="text"
										class="form-control" id="subjectId" name="subjectId"
										required="required" readonly="readonly" value="CO001">
								</div>
								<div class="form-group">
									<label for="subjectName">과정명</label> <input type="text"
										class="form-control" id="subjectName" name="subjectName"
										required="required" value="웹 기반 빅데이터 분석 응용 SW 개발자">
								</div>
								<div class="form-label-group">
									<p>수정 하시겠습니까?</p>
								</div>
