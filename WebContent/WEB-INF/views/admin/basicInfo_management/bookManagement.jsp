...
<body id="page-top">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a
							href="${pageContext.request.contextPath}/admin/basicInfo_management/bookManagement.do">기초
							정보 관리 > 교재 관리</a>
					</div>
					<div class="card-body">
										...
										<tr>
											...
											<td>
												...
												<button type="button"
													...
													${b.bookDel == 0 ? "":"disabled='disabled'"}>삭제</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
	...
	<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">교재 삭제</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
						...
						<form>
							<div class="form-group">
								<div class="form-label-group">
									<p>BO001 / SQL 레벨업 / 9788968482519</p>
								</div>
								<div class="form-label-group">
									<p>삭제하시겠습니까?</p>
								</div>
	...
	<div class="modal fade" id="inputModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">교재 등록</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
				...
				<div class="modal-body">
					<div class="card-body">
						<div class="form-group">
							<form action="${pageContext.request.contextPath}/admin/basicInfo_management/book/insert.do" method="POST" enctype="multipart/form-data">
								<div class="form-group">
								...
								<div class="form-group">
									<label for="isbn_Number">ISBN</label> <input type="text"
										class="form-control" id="isbn_Number" name="isbn_Number"
										required="required">
								</div>
	...
	<div class="modal fade" id="updateModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">교재 수정</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
				...
				<div class="modal-body">
					<div class="card-body">
						<div class="form-group">
							<form>
								<div class="form-group">
									<label for="subjectId">교재번호</label> <input type="text"
										class="form-control" id="subjectId" name="subjectId"
										required="required" readonly="readonly" value="BO001">
								</div>
								<div class="form-group">
									<label for="subjectName">교재명</label> <input type="text"
										class="form-control" id="subjectName" name="subjectName"
										required="required" value="SQL 레벨업">
								</div>
								<div class="form-group">
									<label for="subjectIsbn">ISBN</label> <input type="text"
										class="form-control" id="subjectIsbn" name="subjectIsbn"
										required="required" value="9788968482519">
								</div>
								<div class="form-label-group">
									<p>수정 하시겠습니까?</p>
								</div>
