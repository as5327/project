							...
							<tbody>
								<c:forEach var="l" items="${list}">
									<tr>
										...
										<td>${l.exam_date}</td>
										<td>${l.attendance_distribution}</td>
										<td>${l.written_distribution}</td>
										<td>${l.performance_distribution}</td>
										<td><a
											href="${pageContext.request.contextPath}/admin/score_management/score_for_each_subject4.do">
