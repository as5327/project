				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a
							href="${pageContext.request.contextPath}/admin/score_management/score_for_each_student.do">수강생별
							성적 조회</a> > <a
							href="${pageContext.request.contextPath}/admin/score_management/score_for_each_student2.do">개설
							과정</a> > <a
							href="${pageContext.request.contextPath}/admin/score_management/score_for_each_student3.do">개설
							과목</a>
					</div>
					<div class="card-body">
								...
								<tbody>
									<c:forEach var="l" items="${list}">
										<tr>
											...
											<td><a
												href="${pageContext.request.contextPath}/admin/score_management/score_for_each_student4.do">
