...
<body id="page-top">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a
							href="${pageContext.request.contextPath}/admin/score_management/score_for_each_subject.do">
							개설과목별 성적 조회 > 개설과정</a> > <a
							href="${pageContext.request.contextPath}/admin/score_management/score_for_each_subject2.do">개설과목</a>
						> <a
							href="${pageContext.request.contextPath}/admin/score_management/score_for_each_subject3.do">시험</a>
						> <a
							href="${pageContext.request.contextPath}/admin/score_management/score_for_each_subject4.do">성적</a>
					</div>
					<div class="card-body">
								...
								<tr>
									...
									<td>${os.book_name}
										<button type="button"
											...
											data-target="#bookModal" value="${os.isbn_number}">교재 보기</button>
									</td>
									<td>${os.instructor_name}
										<button type="button"
											class="btn btn-outline-info btn-sm btnTreacher"
											style="float: right;" data-toggle="modal"
											data-target="#teacherModal" value="${os.instructor_pic}">사진 보기</button>
									</td>
								</tr>
							</tbody>
						</table>
						...
						<table class="table table-bordered">
							...
							<tbody>
								<tr>
									<td>${ex.exam_id}</td>
									<td>${ex.exam_question_file}
										<button type="button"
											class="btn btn-outline-info btn-sm btndownload"
											style="float: right;">다운로드</button>
									</td>
									<td>${ex.exam_date}</td>
									<td>${ex.attendance_distribution}</td>
									<td>${ex.written_distribution}</td>
									<td>${ex.performance_distribution}</td>
								</tr>
							</tbody>
						</table>
							...
							<tbody>
								<c:forEach var="l" items="${list}">
									<tr>
										...
										<td>${l.student_regDate}</td>
										<td>${l.attendance_score}</td>
										<td>${l.written_score}</td>
	...
	<div class="modal fade" id="teacherModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">teacher / 김강사</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
