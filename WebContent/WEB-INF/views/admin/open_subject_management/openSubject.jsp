...
<body id="page-top">
								...
								<tbody>
									<c:forEach var="l" items="${list}">
										<tr>
											...
											<td>${l.s_count}</td>
											<td><a
												href="${pageContext.request.contextPath}/admin/open_subject_management/openSubject2.do">
													<button type="button" class="btn btn-outline-primary btn-sm">
														보기<span class="badge badge-dark">${l.os_count}</span>
													</button>
											</a></td>
										</tr>
									</c:forEach>
	...
	<div class="modal fade" id="picModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">admin / 박관리</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
