...
<body id="page-top">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a
							href="${pageContext.request.contextPath}/admin/open_subject_management/openSubject.do">개설
							과목 관리 > 개설 과정</a> > <a
							href="${pageContext.request.contextPath}/admin/open_subject_management/openSubject2.do">개설
							과목</a>
					</div>
					<div class="card-body">
						<div>
								...
								<tbody>
									<c:forEach var="os" items="${osList}">
										<tr>
											...
											<td>${os.instructor_name}곽우신
												<button type="button"
													class="btn btn-outline-info btn-sm btnPic"
													style="float: right;" data-toggle="modal"
													data-target="#picModal" value="${os.instructor_pic}">사진 보기</button>
											</td>
											<td>
												<button type="button"
												...
												<button type="button"
													...
													${os.open_subject_del == 0 ? "":"disabled='disabled'"}>삭제</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
							...
							<form class="form-inline" role="form" method="post"
								...
								<div class="input-group">
									<select class="form-control" id="key" name="key">
										<option>개설 과목 번호</option>
										<option>개설 과목명</option>
									</select>
								</div>
								<div class="input-group">
							...
							<form>
								...
								<div class="form-group">
									<div class="" id="">[OC001 / Python과 Java 응용 SW 실무 개발자 양성
										과정 / 2017-10-15 / 2018-05-08 / 3강의실]</div>
	...
	<div class="modal fade" id="updateModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">개설 과목 수정</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
