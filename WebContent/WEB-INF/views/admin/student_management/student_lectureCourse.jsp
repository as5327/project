				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"></i> <a href="#">메인</a> > <a
							href="${pageContext.request.contextPath}/admin/student_management/student_list.do">수강생
							관리 > 수강생 목록</a> > <a
							href="${pageContext.request.contextPath}/admin/student_management/student_lectureCourse.do">수강
							과정 정보</a>
					</div>
					...
					<div class="card-body">
						<div class="table-responsive">
							<table class="table table-bordered">
								...
								<tbody>
									<tr>
										<td>${slist.student_id}</td>
										<td>${slist.student_name}/
											<button type="button"
												class="btn btn-outline-info btn-sm btnPic"
												style="float: right;" data-toggle="modal"
												data-target="#studentPicture">사진</button>
										</td>
										<td>${slist.student_phone}</td>
										<td>${slist.student_regDate}</td>
										<td>${slist.student_count}</td>
									</tr>
								</tbody>
							</table>
						</div>
