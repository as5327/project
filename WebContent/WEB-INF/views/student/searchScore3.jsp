				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"></i> 성적 조회 > <a
							...
							과목</a> > <a
							href="${pageContext.request.contextPath}/student/score3.do">성적
							조회</a>
					</div>
					<div class="card-body">
							...
							<table class="table table-bordered">
								...
								<tbody>
									<c:forEach items="${list1 }" var="l1">
										<tr>
											<td>${l1.open_course_id }</td>
											<td>${l1.course_name }</td>
											<td>${l1.course_start_date }</td>
											<td>${l1.course_end_date }</td>
											<td>${l1.class_name }</td>
											<td>${l1.status_ }</td>
											<td>${l1.status_date }</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
								...
								<tbody>
									<c:forEach items="${list3 }" var="l3">
										<tr>
											...
											<td>${l3.exam_date }</td>
											<td>${l3.attendance_score }/${l3.attendance_distribution }</td>
											<td>${l3.written_score }/${l3.written_distribution }</td>
											<td>${l3.performance_score }/${l3.performance_distribution }</td>
											<td>${l3.total_score }/${l3.total_distribution }</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
