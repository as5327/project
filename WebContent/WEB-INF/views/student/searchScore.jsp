...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="${pageContext.request.contextPath}/student/student.do">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>
              	성적 조회 >
              	<a href="${pageContext.request.contextPath}/student/score1.do">개설 과정</a>
            </div>
            <div class="card-body">
    ...
    <script>
    	$(document).ready(function(){
    		$(".move").on("click",function(){
    			var s =$(this).parent().siblings().eq(0).text();

    			location.assign("${pageContext.request.contextPath}/student/score2.do?oc="+s);
    		});
