                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                    	...
                    	<td><a href="${pageContext.request.contextPath}/instructor/course_schedule/courseSchedule_now3.do"><button type="button" class="btn btn-outline-primary btn-sm">보기</button></a></td>
                    </tr>
                  </tbody>
                </table>
              </div>
