  ...
  <body id="page-top">
          ...
          <div class="card mb-3">
            <div class="card-header" style="font-size: large;">
              <i class="fas fa-table"></i>
	              ...
	              <span style="font-size: x-small;">(강의 예정)</span> >
	              <a href="${pageContext.request.contextPath}/instructor/course_schedule/courseSchedule_future.do">개설 과정</a> >
	              <a href="${pageContext.request.contextPath}/instructor/course_schedule/courseSchedule_future2.do">개설 과목</a> >
	              <a href="${pageContext.request.contextPath}/instructor/course_schedule/courseSchedule_future3.do">수강생</a>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                    	...
                    	<td>2017-10-15</td>
                    	<td>2017-12-12</td>
                    	<td>오라클 SQL과 PL/SQL을 다루는 기술
                    	<button type="button" class="btn btn-outline-info btn-sm btnBook" style="float:right;" data-toggle="modal" data-target="#bookModal">교재 보기</button>
                    	</td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                    	<td>홍길동
                    	<button type="button" class="btn btn-outline-info btn-sm btnBook" style="float:right;" data-toggle="modal" data-target="#picModal">사진 보기</button>
                    	</td>
                    	<td>010-1234-1234</td>
                    	<td>2017-10-01</td>
                    	<td>수료</td>
    ...
    <div class="modal fade" id="picModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">ST002 / 홍길동</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
