          ...
          <div class="card mb-3">
            <div class="card-header" style="font-size: large;">
              <i class="fas fa-table"></i>
	              ...
	              <span style="font-size: x-small;">(강의 중)</span> >
	              <a href="${pageContext.request.contextPath}/instructor/course_schedule/courseSchedule_now.do">개설 과정</a> >
	              <a href="${pageContext.request.contextPath}/instructor/course_schedule/courseSchedule_now2.do">개설 과목</a> >
	              <a href="${pageContext.request.contextPath}/instructor/course_schedule/courseSchedule_now3.do">수강생</a>
            </div>
            <div class="card-body">
