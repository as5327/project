          ...
          <div class="card mb-3">
            <div class="card-header" style="font-size: large;">
              <i class="fas fa-table"></i>
	              	강의 스케줄 조회
				    <button style="float:right;" class="btn btn-secondary btn-sm dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				      강의 일정 선택
				    </button>
				    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
				      <a class="dropdown-item" href="${pageContext.request.contextPath}/instructor/course_schedule/courseSchedule_future.do">강의 예정</a>
				      <a class="dropdown-item" href="${pageContext.request.contextPath}/instructor/course_schedule/courseSchedule_now.do">강의 중</a>
				      <a class="dropdown-item" href="${pageContext.request.contextPath}/instructor/course_schedule/courseSchedule_past.do">강의 종료</a>
				    </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                    	<td>OC002</td>
                    	<!-- <button type="button" class="btn btn-outline-info btn-sm btnPic" style="float:right;" data-toggle="modal" data-target="#picModal">사진 보기</button> -->
                    	<td>Java 기반 빅데이터 수집 & 네트워크 관리</td>
                    	<td>2018-04-25</td>
                    	<td>2018-12-07</td>
                    	<td>2 강의실</td>
                    	<td>10명</td>
                    	<td><a href="${pageContext.request.contextPath}/instructor/course_schedule/courseSchedule_now2.do"><button type="button" class="btn btn-outline-primary btn-sm">보기</button></a></td>
                    </tr>
                    <tr>
                    	<td>OC003</td>
                    	<!-- <button type="button" class="btn btn-outline-info btn-sm btnPic" style="float:right;" data-toggle="modal" data-target="#picModal">사진 보기</button> -->
                    	...
                    	<td>4 강의실</td>
                    	<td>15명</td>
                    	<td><a href="${pageContext.request.contextPath}/instructor/course_schedule/courseSchedule_future2.do"><button type="button" class="btn btn-outline-primary btn-sm">보기</button></a></td>
                    </tr>
                  </tbody>
                </table>
              </div>
