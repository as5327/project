...
<body id="page-top">
      ...
      <a class="navbar-brand mr-1" href="${pageContext.request.contextPath}/views/teacher/teacherInfo.do">
          ...
          <div class="card mb-3">
            <div class="card-header" style="font-size: large;">
              <i class="fas fa-table"></i>
            	  ...
            	  >
            	  <a href="${pageContext.request.contextPath}/views/teacher/score_management/score_4_student.do">수강생정보</a>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                ...
                <!-- 학생정보 테이블 내용 -->
                <!-- 학생번호/학생이름/연락처/수료중탈여부/해당날짜/출결점수/필기점수/실기점수/총점 -->
                <!-- 학생명 : 학생모달 연동(studentModal) -->
                <!-- 삭제 : 삭제모달 연동(deleteModal) -->
                <!-- 입력 : 입력모달 연동(addModal)-->
                <table class="table table-bordered">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                    	<td>${l4.student_id }</td>
                    	<td>${l4.student_name }</td>
                    	<td>${l4.student_phone }</td>
                    	<td>${l4.status_ }</td>
                    	<td>${l4.end_date }</td>
                    	<td>${l4.attendance_score }</td>
                    	<td>${l4.written_score }</td>
                    	<td>${l4.performance_score }</td>
                    	<td>${l4.total_score }</td>
                    	<td>
                    		<button type="button" class="btn btn-outline-danger btn-sm btnDelete" data-toggle="modal" data-target="#deleteModal">삭제</button>
                    	</td>
                    	<td>
                    		<button type="button" class="btn btn-outline-primary btn-sm btnAdd" data-toggle="modal" data-target="#addModal">등록</button>
                    	</td>
                    </tr>
                    </c:forEach>
                  </tbody>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
       <div class="modal-dialog modal-md">
            ...
            <div class="modal-content">
               <div class="modal-header">
               	  <h4 class="modal-title">성적등록[/]</h4>
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
               </div>
               <form action="${pageContext.request.contextPath}/instructor/score_management/studentScoreAdd.do" 
                	method="POST" enctype="multipart/form-data">
                	
               <input type="hidden" name="open_course_id" value="">
               <input type="hidden" name="open_subject_id" value=""> 
               ...
               <div class="modal-body">
                     ...
                     <label for="attendance_points">출결점수</label> <input type="number"
                        class="form-control" id="attendance_score" name="attendance_score"
                  ...
                  <div class="form-group">
                     <label for="written_points">실기점수</label> <input type="number"
                        class="form-control" id="performance_score" name="performance_score"
                        value="" required>
                  </div>                 
               </div>
               <div class="modal-footer">
