          ...
          <div class="card mb-3">
            <div class="card-header" style="font-size: large;">
              <i class="fas fa-table"></i>
	              <a href="${pageContext.request.contextPath}/instructor/score_management/score_1_openCourse.do">성적관리</a>
	              >
	              <a href="${pageContext.request.contextPath}/instructor/score_management/score_1_openCourse.do">개설과정</a>
            	  >
            	  <a href="${pageContext.request.contextPath}/instructor/score_management/score_2_openSubject.do">개설과목</a>
            </div>
            <div class="card-body">
    ...
    <script>
    	$(document).ready(function(){
    		$(".move").on("click",function(){
    			...
    			location.assign("${pageContext.request.contextPath}/instructor/score_management/score_3_exam.do?os="+os+"&oc="+oc);
    		});
    	});
    </script>
